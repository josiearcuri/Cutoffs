...
result_dir = "sample_results/ReachJ/" +mode+"/"##change this to wherevery you want to save your results
filelist = ['sample_data/firstcl_reachj_1984.csv','sample_data/width_reachj_1984.csv']

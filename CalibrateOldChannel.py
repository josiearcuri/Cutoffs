...
nit = 4000  # number of iterations/how many timesteps to migrate the centerline
...
saved_ts = 200  # timeteps between saving centerlines
crdist = 4 * W  # how close banks get before cutoff in m
cut_thresh = 0
# Set Variables fror Cutoff nonlocal efects
tau = 9  # e-folding timescale for nonlocal effects in years
decay_rate = dt / (tau * (365 * 24 * 60 * 60.0))
# this is the half-life on nonlocal effects, in units of seconds
bump_scale = 2.5  # this is the magnitude of nonlocal effects in relative difference


# Load Existing Centerline

filepath = "data/InitialChannel/InitialCL_62.csv"
# suffix = "cal"

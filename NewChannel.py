...
filepath = "C:/Users/Josie/Desktop/Cutoffs/sample_data/InitialCL2"
if mode == "new":
    ch = mp.generate_initial_channel(W,D,Sl,deltas,pad,100)
else:
    ch= mp.load_initial_channel(filepath+".csv", W, D, Sl, deltas)
...
cl.to_csv("C:/Users/Josie/Desktop/Cutoffs/sample_data/InitialCL2.csv", header = False, index = False)
#chb.create_movie(6000, 6500, "strat", "LateralMigration", result_dir+"movie/", 50, 50, 1, [chb.cl_times, #chb.cutoff_times])
#co.save_animations(result_dir+"movie/*.png", "LateralMigrationmovie.gif")

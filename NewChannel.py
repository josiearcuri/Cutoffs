...
D = 10;   
deltas = 50;
nit = 20              # number of iterations, run for at least 5000 years to see clustering
...
saved_ts = 2               # which time steps will be saved
...
filepath ="sample_results/InitialChannel/InitialCL_2mpyr.csv"
...
cl.to_csv(result_dir+"InitialCL_2mpyr.csv", header = False, index = False)